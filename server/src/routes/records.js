...
const VALID_TRANSITIONS = {
  ...
  filed:              ['estimate', 'void'],
  approved:           ['schedule_customer', 'in_progress', 'order_parts', 'on_hold', 'void'],
  schedule_customer:  ['scheduled', 'in_progress', 'order_parts', 'on_hold', 'void'],
  scheduled:          ['in_progress', 'order_parts', 'on_hold', 'void'],
  in_progress:        ['order_parts', 'awaiting_parts', 'awaiting_approval', 'complete', 'on_hold', 'void'],
